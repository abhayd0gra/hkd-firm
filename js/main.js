...
const T = {
  en: {
    ...
    'why.c2.text':  'Audit, taxation, GST, corporate law, and business advisory are all practised with equal rigour by our dedicated in-house team. Clients receive integrated advice without the fragmentation of dealing with multiple advisors across disciplines.',
    'why.c3.title': 'Relationships, Not Transactions',
    'why.c3.text':  'The majority of our clients have been with the firm for over a decade. We treat every engagement as an ongoing fiduciary responsibility, not merely a one-time assignment, and we make ourselves available for counsel at every stage of a client\'s business journey.',
    ...
    'testi.subtitle':'Placeholder testimonials, to be replaced with verified client and partner statements.',
    'testi.1.text':  'We have been with CA Dogra\'s firm for over fifteen years. Through every tax assessment, GST transition, and business restructuring, their advice has been precise, timely, and grounded in a deep understanding of our specific industry. We consider them an integral part of our management team.',
    'testi.1.name':  'Managing Director',
    'testi.1.role':  'Mid-size Manufacturing Enterprise, Bangalore',
    'testi.2.text':  'When we were navigating the acquisition of a new property, Harish Kumar Dogra & Co. uncovered liabilities that our internal team had completely missed. Their due diligence saved us from a very costly transaction. I would recommend them without reservation to any business owner.',
    'testi.2.name':  'Proprietor',
    'testi.2.role':  'Hospitality Group, South Bangalore',
    'testi.3.text':  'The firm represented us before the ITAT and secured the deletion of a substantial tax addition that had been hanging over our business for two years. CA Dogra\'s command of the facts and the law was exceptional. The outcome exceeded our expectations entirely.',
    'testi.3.name':  'Director',
    'testi.3.role':  'Real Estate Development Company, Bangalore',
  ...
  hi: {
    ...
    'about.p2':           'चार दशकों के आर्थिक परिवर्तन में, उदारीकरण से जीएसटी कार्यान्वयन तक, फर्म विनिर्माण, आतिथ्य, व्यापार, रियल एस्टेट, ई-कॉमर्स और कृषि क्षेत्र के व्यवसायों की एक विश्वसनीय परामर्शदाता बनी रही है।',
    ...
    'testi.subtitle':'प्लेसहोल्डर प्रशंसापत्र, सत्यापित ग्राहक और भागीदार वक्तव्यों से प्रतिस्थापित किए जाएंगे।',
    'testi.1.text':  'हम पंद्रह से अधिक वर्षों से CA डोगरा की फर्म के साथ हैं। हर कर मूल्यांकन, GST संक्रमण और व्यापार पुनर्गठन में उनकी सलाह सटीक, समयोचित और हमारे उद्योग की गहरी समझ पर आधारित रही है।',
    'testi.1.name':  'प्रबंध निदेशक',
    'testi.1.role':  'मध्यम आकार का विनिर्माण उद्यम, बैंगलोर',
    'testi.2.text':  'जब हम एक नई संपत्ति का अधिग्रहण कर रहे थे, हरीश कुमार डोगरा एंड कंपनी ने ऐसी देनदारियां उजागर कीं जो हमारी आंतरिक टीम से छूट गई थीं। उनकी ड्यू डिलिजेंस ने हमें एक बहुत महंगे लेनदेन से बचाया।',
    'testi.2.name':  'स्वामी',
    'testi.2.role':  'आतिथ्य समूह, दक्षिण बैंगलोर',
    'testi.3.text':  'फर्म ने ITAT के समक्ष हमारा प्रतिनिधित्व किया और दो वर्षों से हमारे व्यवसाय पर लटके एक बड़े कर अतिरिक्त जोड़ को हटवाया। CA डोगरा की तथ्यों और कानून पर पकड़ असाधारण थी।',
    'testi.3.name':  'निदेशक',
    'testi.3.role':  'रियल एस्टेट विकास कंपनी, बैंगलोर',
